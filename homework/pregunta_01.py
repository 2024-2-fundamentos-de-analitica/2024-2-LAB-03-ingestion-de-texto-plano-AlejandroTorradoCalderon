    ...
    for line in lines:
        ...
        if match:
            ...
            if current_row["Cluster"] is not None:
                ...
                # Asegurar que las comas estén seguidas de un solo espacio
                keywords = re.sub(r',\s*', ', ', keywords)
                # Eliminar comas duplicadas o espacios antes de comas
            ...
            # Encuentra la posición después del porcentaje
